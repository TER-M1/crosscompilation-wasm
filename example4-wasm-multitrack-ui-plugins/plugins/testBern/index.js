  ...
  class testBernardNode extends CompositeAudioNode {
    _wamNode;
  ...
  export default class testBernardPlugin extends WebAudioModule {
    _PluginFactory;

    _baseURL = getBasetUrl(new URL('.',
      import.meta.url));
    ...
    async createAudioNode(initialState) {
      ...
      const node = new testBernardNode(this.audioContext);
